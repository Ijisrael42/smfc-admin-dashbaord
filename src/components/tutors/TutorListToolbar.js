...
const TutorListToolbar = (props) => {
  ...
  const confirm = () => {
    ...
    tutorService.update(id, { account_status: value })
  ...
  return (
    <>
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description" >
        <DialogTitle id="alert-dialog-title"> {state} Tutor </DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Are you sure you want to {state} this Tutor
          </DialogContentText>
        </DialogContent>
        <DialogActions>
...
export default TutorListToolbar;
